...
import com.lucky.kidstv.server.PlayService;
import com.lucky.kidstv.ui.adapter.SeriesAdapter;
import com.lucky.kidstv.ui.adapter.SeriesFlagAdapter;
import com.lucky.kidstv.ui.adapter.SeriesGroupAdapter;
import com.lucky.kidstv.ui.dialog.DescDialog;
import com.lucky.kidstv.ui.dialog.PushDialog;
import com.lucky.kidstv.ui.dialog.QuickSearchDialog;
import com.lucky.kidstv.ui.fragment.PlayFragment;
...
import com.lucky.kidstv.util.SearchHelper;
...
//        mGridView.setLayoutManager(new V7GridLayoutManager(this.mContext, isBaseOnWidth() ? 6 : 7));
        ...
        mGridView.setOnItemListener(new TvRecyclerView.OnItemListener() {
            ...
            public void onItemClick(TvRecyclerView parent, View itemView, int position) {
                ...
                if (seriesAdapter.getOnItemClickListener() != null) {
                    seriesAdapter.getOnItemClickListener().onItemClick(seriesAdapter, itemView, position);
                }
            }
        });
