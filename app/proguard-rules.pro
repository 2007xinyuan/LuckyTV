...
# 实体类
#-keep class com.lucky.kidstv.bean.** { *; }
-keep class com.lucky.kidstv.ui.fragment.homes.**{*;}
#CardView
-keep class com.lucky.kidstv.ui.tv.widget.card.**{*;}
#ViewObj
-keep class com.lucky.kidstv.ui.tv.widget.ViewObj{
    <methods>;
}
